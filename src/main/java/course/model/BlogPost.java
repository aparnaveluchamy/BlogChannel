...
public class BlogPost {
    ...
    public BlogPost(final MongoDatabase blogDatabase) {
    ...
    public void likePost(final String permalink, final int ordinal) {
       postsCollection.updateOne(eq("permalink", permalink), new Document("$inc", new Document("comments." + ordinal + ".num_likes",1)));
    }
}
